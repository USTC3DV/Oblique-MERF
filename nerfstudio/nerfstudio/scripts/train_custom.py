...
from merf.merf_config import merf_config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default="/home/zengxy/data/ustc_b1")
    parser.add_argument('--load_config', type=str, default="/home/zengxy/code/merfstudio1/outputs/ustc_b1/merf-ns/2023-12-28_234154/config.yml")
    parser.add_argument('--exp_name', type=str, default='ustc_b1')
    parser.add_argument('--gpu', type=int, default=0)
    args = parser.parse_args()

    # with open("/home/paradise/code/sdfstudio/ustc_block.json", 'r') as f:
    #     block_json = json.load(f)
    tyro.extras.set_accent_color("bright_yellow")

    # cur_config = method_configs["merf-ns"]
    cur_config = merf_config
    cur_config.set_timestamp()
    # deal with some params for dataparser and datamanager
    cur_config.load_config = Path(args.load_config)
    cur_config.pipeline.datamanager.train_num_rays_per_batch = 4096
    # cur_config.pipeline.datamanager.dataparser.data = Path(args.data)
    # cur_config.experiment_name = args.exp_name
    # cur_config.pipeline.datamanager.dataparser.use_all_train_images = True
    # cur_config.pipeline.datamanager.dataparser.orientation_method = 'vertical'
    # cur_config.pipeline.model.weight_mask = True
    # cur_config.pipeline.model.occ_start_step = -1
    # cur_config.pipeline.model.occ_loss_mult_param = (-1, 6200, 1e-5, 1.25, 1e-2)
    # cur_config.pipeline.model.occ_celoss_mult =  0.0
    # cur_config.load_checkpoint = "/home/zengxy/code/merfstudio1/outputs/ustc_b1/merf-ns/2023-12-27_222407/nerfstudio_models/step-000079999.ckpt"
