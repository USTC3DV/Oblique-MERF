...
class Nerfstudio(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        if self.config.data.suffix == ".json":
            ...
            meta = load_from_json(self.config.data / "transforms_new.json")
        ...
        transform_matrix = torch.eye(4)[:-1,:]
        ...
        #     )
        # )
        scene_box = SceneBox(aabb=torch.from_numpy(np.array(meta['aabb']).astype(np.float32)))
